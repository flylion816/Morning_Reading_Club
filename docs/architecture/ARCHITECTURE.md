...
> **当前维护说明（2026-05-12）**
> 本文档保留为架构图和存储背景说明。当前代码同步后的详细设计入口为：
> [`docs/architecture/DETAILED-DESIGN-代码同步版-2026-05-12.md`](./DETAILED-DESIGN-代码同步版-2026-05-12.md)。
> 后续涉及页面、接口、数据流、鉴权和长图分享的设计更新，应优先维护该详细设计文档。
