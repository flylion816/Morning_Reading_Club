...
> **当前维护说明（2026-05-12）**
> 本文档保留为 Postman 测试说明和历史样例。当前后端路由事实以
> [`docs/backend/API-接口索引-代码同步版-2026-05-12.md`](./API-接口索引-代码同步版-2026-05-12.md)
> 为准。本文档中的真实 token、密码或线上用户示例不应继续复制到新文档；后续应替换为占位符并通过安全凭据管理。
