  ...
  apps: [
    {
      ...
      // =====================================================================
      // 安装：npm install pm2-logrotate --save-dev
      // 启动：pm2 install pm2-logrotate
      // 配置：pm2 set pm2-logrotate:max_size 10M
      //      pm2 set pm2-logrotate:retain 5
      //
      // 参数说明：
      // max_size: 单个日志文件大小限制（10M = 10MB）
      // retain: 保留的日志文件数量（5个 = 最多保留 50MB 日志）

      // =====================================================================
      // 监听文件变化
      // 生产环境关闭 watch，避免部署拷贝和日志轮转触发额外重启。
      // =====================================================================
      watch: false,
