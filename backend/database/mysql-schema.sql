...
CREATE TABLE IF NOT EXISTS users (
  ...
  phone_bind_at DATETIME DEFAULT NULL COMMENT '手机号绑定时间',
...
CREATE TABLE IF NOT EXISTS enrollments (
  ...
  phone VARCHAR(20) DEFAULT NULL COMMENT '手机号',
  inviter_id CHAR(24) DEFAULT NULL COMMENT '邀请人ID（用于裂变统计）',
...
CREATE TABLE IF NOT EXISTS insights (
  ...
  period_id CHAR(24) NOT NULL COMMENT '期次 ID',
  period_name VARCHAR(100) DEFAULT NULL COMMENT '期次名称快照',
...
CREATE TABLE IF NOT EXISTS comments (
  ...
  reply_to_user_id CHAR(24) COMMENT '回复给哪个用户',
  reply_count INT DEFAULT 0 COMMENT '回复数',
  like_count INT DEFAULT 0 COMMENT '点赞数',
  likes JSON DEFAULT NULL COMMENT '点赞用户列表',
